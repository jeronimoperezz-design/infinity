...
<body>
  ...
  <main>
    <section class="catalogo-section">
      <h1>CATÁLOGO DE HOMBRES</h1> <br> <h1>NOVEDADES</h1>
      <div class="catalogo-grid">
        <div class="catalogo-item">
          <img src="img/camisanegra.jpg" alt="Camisa Negra Clásica">
          <h2>Camisa Negra Clásica</h2>
          <p>Camisa de algodón premium, corte slim fit, color negro profundo.</p>
          <span class="catalogo-precio">$49.900</span>
          <button class="btn">AGREGAR AL CARRITO</button>
        </div>
        <div class="catalogo-item">
          <img src="img/camisetaminimal.jpg" alt="Camiseta Blanca Minimal">
          <h2>Camiseta Blanca Minimal</h2>
          <p>Camiseta blanca, diseño minimalista, tela suave y fresca.</p>
