                                                        ...
                                                        <?php foreach($usuarios as $usuario) {?>
                                                            <tr>
                                                                ...
                                                                <td> <?php echo $usuario['tipo'] ?> </td>
                                                                   <td><form action="modaleditaru.php" method="POST">
                                                                ...
                                                                <td><center>
                                                                    <form action="modaleliminaru.php" method="POST">
                                                                        <input type="hidden" name="id_usu" id="id_usu" value="<?php echo $usuario['id_usu'];?>">
                                                                        <button type="submit" class="form-control" id="eliminaru" nombre="eliminaru"><i class="fa-solid fa-trash"></i></button>
                                                                    </form></center></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <select type="text" name="tipo" id="tipo" class="form-select">
                                                    ...
                                                    <option value="2">Cliente Tipo 2</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
